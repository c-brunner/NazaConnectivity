...
#define MAVLINK_MSG_ID_ATTITUDE_CONTROLLER_OUTPUT_CRC 45
#define MAVLINK_MSG_ID_60_CRC 45



#define MAVLINK_MESSAGE_INFO_ATTITUDE_CONTROLLER_OUTPUT { \
	"ATTITUDE_CONTROLLER_OUTPUT", \
	5, \
	{  { "enabled", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_attitude_controller_output_t, enabled) }, \
         { "roll", NULL, MAVLINK_TYPE_INT8_T, 0, 1, offsetof(mavlink_attitude_controller_output_t, roll) }, \
         { "pitch", NULL, MAVLINK_TYPE_INT8_T, 0, 2, offsetof(mavlink_attitude_controller_output_t, pitch) }, \
         { "yaw", NULL, MAVLINK_TYPE_INT8_T, 0, 3, offsetof(mavlink_attitude_controller_output_t, yaw) }, \
         { "thrust", NULL, MAVLINK_TYPE_INT8_T, 0, 4, offsetof(mavlink_attitude_controller_output_t, thrust) }, \
         } \
}
 ...
 */
static inline uint16_t mavlink_msg_attitude_controller_output_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint8_t enabled, int8_t roll, int8_t pitch, int8_t yaw, int8_t thrust)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_ATTITUDE_CONTROLLER_OUTPUT_LEN];
	_mav_put_uint8_t(buf, 0, enabled);
	_mav_put_int8_t(buf, 1, roll);
	_mav_put_int8_t(buf, 2, pitch);
	_mav_put_int8_t(buf, 3, yaw);
	_mav_put_int8_t(buf, 4, thrust);

        memcpy(_MAV_PAYLOAD_NON_CONST(msg), buf, MAVLINK_MSG_ID_ATTITUDE_CONTROLLER_OUTPUT_LEN);
#else
	mavlink_attitude_controller_output_t packet;
	...
	packet.thrust = thrust;
        ...
        memcpy(_MAV_PAYLOAD_NON_CONST(msg), &packet, MAVLINK_MSG_ID_ATTITUDE_CONTROLLER_OUTPUT_LEN);
#endif

	msg->msgid = MAVLINK_MSG_ID_ATTITUDE_CONTROLLER_OUTPUT;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_ATTITUDE_CONTROLLER_OUTPUT_LEN, MAVLINK_MSG_ID_ATTITUDE_CONTROLLER_OUTPUT_CRC);
#else
...
/**
 * @brief Pack a attitude_controller_output message on a channel
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_attitude_controller_output_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
						           ...
						           uint8_t enabled,int8_t roll,int8_t pitch,int8_t yaw,int8_t thrust)
{
	...
	msg->msgid = MAVLINK_MSG_ID_ATTITUDE_CONTROLLER_OUTPUT;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_ATTITUDE_CONTROLLER_OUTPUT_LEN, MAVLINK_MSG_ID_ATTITUDE_CONTROLLER_OUTPUT_CRC);
#else
...
/**
 * @brief Encode a attitude_controller_output struct
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
...
/**
 * @brief Encode a attitude_controller_output struct on a channel
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param chan The MAVLink channel this message will be sent over
 ...
 * @param attitude_controller_output C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_attitude_controller_output_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_attitude_controller_output_t* attitude_controller_output)
{
	return mavlink_msg_attitude_controller_output_pack_chan(system_id, component_id, chan, msg, attitude_controller_output->enabled, attitude_controller_output->roll, attitude_controller_output->pitch, attitude_controller_output->yaw, attitude_controller_output->thrust);
}
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ATTITUDE_CONTROLLER_OUTPUT, buf, MAVLINK_MSG_ID_ATTITUDE_CONTROLLER_OUTPUT_LEN, MAVLINK_MSG_ID_ATTITUDE_CONTROLLER_OUTPUT_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ATTITUDE_CONTROLLER_OUTPUT, buf, MAVLINK_MSG_ID_ATTITUDE_CONTROLLER_OUTPUT_LEN);
#endif
#else
	mavlink_attitude_controller_output_t packet;
	packet.enabled = enabled;
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ATTITUDE_CONTROLLER_OUTPUT, (const char *)&packet, MAVLINK_MSG_ID_ATTITUDE_CONTROLLER_OUTPUT_LEN, MAVLINK_MSG_ID_ATTITUDE_CONTROLLER_OUTPUT_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ATTITUDE_CONTROLLER_OUTPUT, (const char *)&packet, MAVLINK_MSG_ID_ATTITUDE_CONTROLLER_OUTPUT_LEN);
#endif
#endif
}

#if MAVLINK_MSG_ID_ATTITUDE_CONTROLLER_OUTPUT_LEN <= MAVLINK_MAX_PAYLOAD_LEN
/*
 ...
 */
static inline void mavlink_msg_attitude_controller_output_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t enabled, int8_t roll, int8_t pitch, int8_t yaw, int8_t thrust)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#endif
#else
	mavlink_attitude_controller_output_t *packet = (mavlink_attitude_controller_output_t *)msgbuf;
	packet->enabled = enabled;
	packet->roll = roll;
	packet->pitch = pitch;
	packet->yaw = yaw;
...
#else
	memcpy(attitude_controller_output, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_ATTITUDE_CONTROLLER_OUTPUT_LEN);
#endif
}
