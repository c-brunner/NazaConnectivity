...
#define MAVLINK_MSG_ID_PARAM_REQUEST_READ_CRC 213
#define MAVLINK_MSG_ID_20_CRC 213
...
#define MAVLINK_MESSAGE_INFO_PARAM_REQUEST_READ { \
	"PARAM_REQUEST_READ", \
	4, \
	{  { "param_index", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_param_request_read_t, param_index) }, \
...
static inline uint16_t mavlink_msg_param_request_read_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint8_t target_system, uint8_t target_component, const int8_t *param_id, uint16_t param_index)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_PARAM_REQUEST_READ_LEN];
	_mav_put_uint16_t(buf, 0, param_index);
 ...
 */
static inline void mavlink_msg_param_request_read_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, const int8_t *param_id, uint16_t param_index)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
