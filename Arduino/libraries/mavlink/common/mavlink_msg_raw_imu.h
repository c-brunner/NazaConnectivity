...
#define MAVLINK_MSG_ID_RAW_IMU_CRC 237
#define MAVLINK_MSG_ID_28_CRC 237
...
#define MAVLINK_MESSAGE_INFO_RAW_IMU { \
	...
	{  { "usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_raw_imu_t, usec) }, \
         ...
         { "xgyro", NULL, MAVLINK_TYPE_UINT16_T, 0, 14, offsetof(mavlink_raw_imu_t, xgyro) }, \
         { "ygyro", NULL, MAVLINK_TYPE_UINT16_T, 0, 16, offsetof(mavlink_raw_imu_t, ygyro) }, \
         { "zgyro", NULL, MAVLINK_TYPE_UINT16_T, 0, 18, offsetof(mavlink_raw_imu_t, zgyro) }, \
...
static inline uint16_t mavlink_msg_raw_imu_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint64_t usec, int16_t xacc, int16_t yacc, int16_t zacc, uint16_t xgyro, uint16_t ygyro, uint16_t zgyro, int16_t xmag, int16_t ymag, int16_t zmag)
{
	...
	_mav_put_uint16_t(buf, 14, xgyro);
	_mav_put_uint16_t(buf, 16, ygyro);
	_mav_put_uint16_t(buf, 18, zgyro);
 ...
 */
static inline void mavlink_msg_raw_imu_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t usec, int16_t xacc, int16_t yacc, int16_t zacc, uint16_t xgyro, uint16_t ygyro, uint16_t zgyro, int16_t xmag, int16_t ymag, int16_t zmag)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
